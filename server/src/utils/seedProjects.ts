...
const sampleProjects = [
  ...
  // Landscape Projects
  {
    ...
    description: "A transformative public space featuring native plantings, water features, and flexible community gathering areas.",
    fullDescription: "This urban garden plaza transforms a previously underutilized city block into a vibrant community destination. The design incorporates sustainable stormwater management through bioswales and rain gardens, while native plant selections support local wildlife. Flexible paving systems allow the space to accommodate both daily pedestrian traffic and special events. Integrated seating and shade structures create comfortable environments for relaxation and social interaction.",
    category: "landscape",
    status: "completed",
    images: [
      "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
      "https://images.unsplash.com/photo-1596345389650-2e35bce940d6?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
      "https://images.unsplash.com/photo-1601052904048-4ba3b3c30c8c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80"
    ],
    thumbnailImage: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    location: "Denver, CO",
    year: 2023,
    client: "City of Denver",
    area: 1200,
    budget: 650000,
    tags: ["urban", "plaza", "community", "sustainable"],
    featured: true,
    published: true
  },
  {
