      ...
      <div className="container-max section-padding py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-primary-300 mb-6 max-w-md">
              ...
              We transform your vision into stunning reality.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/projects" className="text-primary-300 hover:text-accent-400 transition-colors">
                  Our Projects
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3 text-primary-300">
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 mt-1 text-accent-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span>123 Architecture St, Design City, DC 12345</span>
              </div>
        ...
        <div className="border-t border-primary-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link to="/terms" className="text-primary-400 hover:text-accent-400 text-sm transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
